    ...
    <main className="h-screen overflow-hidden relative">
      ...
      <div className="absolute rounded-t-2xl bg-white/50 w-full h-1/3 bottom-0 p-4">
        ...
        <p className="line-clamp-5">
          What's happened to the Sun? Two days ago, parts of South America were
          treated to a partial solar eclipse -- where the Moon blocked out part
          of the Sun. The featured image shows an image of the partially
          eclipsed Sun through clouds as it was setting over Patagonia,
          ...
          thick cloud. In about two weeks, all of South America and part of
          North America will experience a total lunar eclipse -- where the Earth
          moves completely between the Moon and the Sun. In about two years, a
          total solar eclipse will cross North America.
        </p>
      </div>
    </main>
  );
